...
<template>
    <dialog @keyup.esc='$emit("close-dialog")' @keyup.ctrl.enter='$emit("confirm-dialog")'
        class="dialog text flex flex-col" open>
        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            <input type="number" class="dialog-input" step="0.01" id="protein" v-model="selected.protein"
                :disabled="isFoodID" />
            <label for="fat">Fat (g)</label>
            <label for="carb">Carbs (g)</label>
            <input type="number" class="dialog-input" step="0.01" id="fat" v-model="selected.fat"
                :disabled="isFoodID" />
            <input type="number" class="dialog-input" step="0.01" id="carb" v-model="selected.carbs"
                :disabled="isFoodID" />
        </div>
